...
class Credits extends React.Component {
    ...
    render() {
        return (
          ...
          <div style={{ fontSize: '12px',color: '#aaa',padding: '10px 20px',letterSpacing: '0.5px'}}>Designed by <a style={{color:'#2998ff',textDecoration:'none',fontWeight:400}} target="_blank" href="http://www.sankalpsinha.com">Sankalp</a> | Developed by <a style={{color:'#2998ff',textDecoration:'none',fontWeight:400}} target="_blank" href="http://www.roshanraj.com">Roshan</a> & <a style={{color:'#2998ff',textDecoration:'none',fontWeight:400}}  target="_blank" href="https://www.vishalranjan.in">Vishal</a> </div>
		     </div>
